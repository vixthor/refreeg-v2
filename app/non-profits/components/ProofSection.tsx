...
export default function ProofSection() {
  ...
  return (
    <motion.div 
      className="bg-gradient-to-br from-gray-50 to-blue-50 flex items-start justify-center px-6 pt-20 pb-12 relative overflow-hidden"
      initial="hidden"
      whileInView="visible"
    ...
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            <motion.div 
              className="bg-white/80 backdrop-blur-sm rounded-full px-6 py-3 border border-gray-200/50 shadow-sm"
              whileHover={{ 
                scale: 1.02,
          ...
          >
            <motion.h1 
              className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight whitespace-nowrap"
        ...
        {/* Visual Section */}
        <motion.div 
          className="relative flex justify-center lg:justify-end mt-[135px]"
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="relative mb-6">
                ...
                <div className="flex items-end justify-center space-x-2">
                  {[...Array(8)].map((_, i) => (
                    <motion.div
                      key={i}
                      className="w-8 h-8 bg-gradient-to-br from-yellow-300 to-yellow-500 rounded-full shadow-lg"
              ...
              >
                <div className="relative">
                  <motion.div 
                    className="w-24 h-24 bg-gradient-to-br from-purple-400 to-purple-600 rounded-full flex items-center justify-center shadow-xl"
              ...
              />
              <motion.div
                className="absolute top-1/2 -right-6 w-3 h-3 bg-purple-400 rounded-full"
                animate={{ 
                  scale: [1, 2, 1],
                  opacity: [1, 0, 1]
                }}
            ...
            <motion.div
              className="absolute -top-8 -left-8 w-12 h-12 bg-gradient-to-br from-yellow-300 to-yellow-500 rounded-full shadow-lg"
              animate={{
                y: [0, -20, 0],
                rotate: [0, 180, 360],
                scale: [1, 1.1, 1]
            ...
            <motion.div
              className="absolute -bottom-4 -right-8 w-10 h-10 bg-gradient-to-br from-green-300 to-green-500 rounded-full shadow-lg"
              animate={{
                y: [0, 15, 0],
                rotate: [0, -180, -360],
                scale: [1, 1.2, 1]
