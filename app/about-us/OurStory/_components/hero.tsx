      ...
      <div className="w-full lg:w-8/12">
        <div className="w-full lg:w-5/6 mb-7">
          ...
          <div className="text-sm md:text-base lg:text-lg">
            ...
            We believe that helping others should not be complicated. Yet, many
            people hesitate to donate because they fear their money won&apos;t
            reach the right hands. We asked ourselves:
            <Ul>
