...
import { Shield, CheckCircle, Clock, XCircle, FileText, User, Calendar, Phone, MapPin } from "lucide-react";
      ...
      {kycData && (
        <Card className="shadow-lg">
          <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50">
            ...
            <CardDescription>Information you provided for verification</CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">{kycData.full_name || "-"}</span>
                  </div>
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">{kycData.phone || "-"}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">{kycData.address || "-"}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <MapPin className="h-4 w-4 text-gray-500" />
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">{kycData.state || "-"}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <MapPin className="h-4 w-4 text-gray-500" />
                    <span className="font-medium">Postal Code:</span>
                    <span className="text-gray-700">{kycData.postal || "-"}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <MapPin className="h-4 w-4 text-gray-500" />
                    <span className="font-medium">Country:</span>
                    <span className="text-gray-700">{kycData.country || "-"}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-700">{kycData.document_type || "-"}</span>
            </div>
          </CardContent>
        </Card>
      )}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {kycData?.status === "pending" && (
              <div className="text-center text-gray-600">
                ...
                <p>Your KYC is under review. Please wait for admin approval.</p>
              </div>
            )}
