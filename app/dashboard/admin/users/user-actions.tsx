        ...
        <DropdownMenuContent align="end">
          ...
          {currentUserRole === "admin" && userItem.role !== "admin" && (
            <>
              {userItem.role === "manager" ? (
                <DropdownMenuItem
                  onClick={() =>
                    handleRemoveManager(userItem.id, userItem.email)
                  }
                >
                ...
                <DropdownMenuItem
                  onClick={() =>
                    handleAppointManager(userItem.id, userItem.email)
                  }
                >
          ...
          {userItem.role !== "admin" && (
            <>
              {userItem.is_blocked ? (
                <DropdownMenuItem
                  onClick={() => handleUnblockUser(userItem.id, userItem.email)}
                >
                ...
                <DropdownMenuItem
                  onClick={() => handleBlockUser(userItem.id, userItem.email)}
                >
