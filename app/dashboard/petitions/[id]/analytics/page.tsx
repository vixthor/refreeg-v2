        ...
        return (
            <div className="container mx-auto py-8">
                <div className="text-center">
                    ...
                    <p className="text-muted-foreground">Unable to load analytics data for this Petition.</p>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="container mx-auto py-8">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground">Track your petition's performance and engagement</p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-8">
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{formatCurrency(analytics.overview.totalSignatures)}</div>
                        <p className="text-xs text-muted-foreground">from {analytics.overview.totalSigners} donors</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium">Average Signature</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold">{formatCurrency(analytics.overview.averageSignature)}</div>
